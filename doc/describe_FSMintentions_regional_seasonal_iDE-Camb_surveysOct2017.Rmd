...
load_libraries(                                      # Install & load libraries
  c("rio", "gplots", "Amelia", "car", "fastDummies", "corrplot",
    "FactoMineR", "factoextra", "lavaan", "purrr", "tidyr",
    "ggplot2", "ltm", "vcd", "gmodels", "pscl", "DescTools", "ROCR",
    "nnet", "tidyverse", "caret", "MASS", "mda", "mvtnorm", "klaR",
    "scales", "gridExtra", "tibble"))
...
if (clean.raw.data != 1) {
  ...
  d.surv$SatisColaps = recode(d.surv$Satis, DK = "DK", "1" = "1", "2" = "1", 
                              "3" = "2", "4" = "3", "5" = "3")
  d.surv$SatisSupColaps = recode(d.surv$SatisSup, "DK" = "DK", "1" = "1",
                                 "2" = "1", "3" = "2", "4" = "3", "5" = "3")
  d.surv$SatisColapsMore = recode(d.surv$Satis, "DK" = "DK", "1" = "1", 
                                  "2" = "1", "3" = "1", "4" = "2", "5" = "2")
  d.surv$SatisSupColapsMore = recode(d.surv$SatisSup, "DK" = "DK", "1" = "1",
                                     "2" = "1", "3" = "1", "4" = "2", "5" = "2")
  ...
  # province order: Banteay Meanchey, Kampong Thom, Kandal, Oddar Meanchey, 
  # Prey Veng, Siem Reap, Svay Rieng
  ...
  d.sets.prov$Pop014Perc =                           # NIS CIPS, Report 3, 2013
    c(28.49, 31.56, 26.80, 32.17, 31.01, 33.95, 27.20)/100
  d.sets.prov$Pop1549Perc =                          # NIS CIPS, Report 3, 2013
    c(53.89, 54.13, 55.89, 55.86, 53.00, 53.62, 57.22)/100
  d.sets.prov$Pop5064Perc =                          # NIS CIPS, Report 3, 2013
    c(12.68, 10.15, 11.16, 9.67, 10.49, 8.93, 10.75)/100
  d.sets.prov$Pop65upPerc =                          # NIS CIPS, Report 3, 2013
    c(4.95, 4.16, 6.14, 2.30, 5.50, 3.50, 4.83)/100
  ...
  d.sets.prov$MaridNevrMPerc =                       # NIS CIPS, Report 4, 2014
    c(33.2, 32.6, 37.3, 34.4, 29.5, 34.2, 32.0)/100
  d.sets.prov$MaridNevr2024MPerc =                   # NIS CIPS, Report 4, 2014
    c(70.79, 71.02, 81.85, 61.32, 67.00, 69.45, 65.75)/100
  d.sets.prov$MaridNevrFPerc =                       # NIS CIPS, Report 4, 2014
    c(26.9, 25.6, 29.4, 25.6, 24.6, 28.8, 24.5)/100
  d.sets.prov$MaridNevr2024FPerc =                   # NIS CIPS, Report 4, 2014
    c(54.40, 40.84, 60.29, 42.70, 40.60, 49.58, 37.70)/100
  d.sets.prov$MaridNevr2024DiffMFPerc =              # + value = F more
    d.sets.prov$MaridNevr2024F - d.sets.prov$MaridNevr2024M
  d.sets.prov$MaridNevr4549FPerc =                   # NIS CIPS, Report 4, 2014
    c(4.38, 5.26, 7.32, 0.67, 6.09, 4.37, 5.87)/100
  d.sets.prov$MaridMPerc =                           # NIS CIPS, Report 4, 2014
    c(64.7, 65.0, 59.9, 64.2, 67.9, 63.5, 66.5)/100
  d.sets.prov$MaridFPerc =                           # NIS CIPS, Report 4, 2014
    c(64.5, 62.5, 58.0, 66.3, 65.4, 59.5, 64.2)/100
  d.sets.prov$WidwdMPerc =                           # NIS CIPS, Report 4, 2014
    c(1.38, 1.75, 1.72, 0.93, 1.30, 1.46, 1.03)/100
  d.sets.prov$Widwd60upMPerc =                       # NIS CIPS, Report 4, 2014
    c(8.54, 11.17, 28.23, 7.54, 5.94, 12.54, 6.18)/100
  d.sets.prov$WidwdFPerc =                           # NIS CIPS, Report 4, 2014
    c(6.76, 8.93, 9.31, 6.60, 7.49, 8.67, 9.14)/100
  d.sets.prov$Widwd60upFPerc =                       # NIS CIPS, Report 4, 2014
    c(33.10, 48.92, 39.62, 32.94, 31.77, 38.33, 38.63)/100
  d.sets.prov$Widwd60upDiffMFPerc =                  # + value = F more
    d.sets.prov$Widwd60upF - d.sets.prov$Widwd60upM
  d.sets.prov$DvrcdSepMPerc =                        # NIS CIPS, Report 4, 2014
    c(0.73, 0.62, 1.06, 0.47, 1.30, 0.82, 0.43)/100
  d.sets.prov$DvrcdSepFPerc =                            # NIS CIPS, Report 4, 2014
    c(1.80, 2.99, 3.30, 1.44, 2.50, 3.07, 2.10)/100
  d.sets.prov$DvrcdSep60upFPerc =                        # NIS CIPS, Report 4, 2014
    c(1.07, 3.67, 1.48, 3.15, 3.11, 4.09, 2.41)/100
  ...
  d.sets.prov$DisabPerc =                             # NIS CIPS, Report 5, 2013
    c(1.90, 3.36, 1.60, 3.54, 2.19, 2.43, 1.88)/100
  d.sets.prov$DisabMPerc =                            # NIS CIPS, Report 5, 2013
    c(1.98, 3.56, 1.54, 4.43, 2.03, 2.86, 2.45)/100
  d.sets.prov$DisabFPerc =                            # NIS CIPS, Report 5, 2013
    c(1.83, 3.17, 1.65, 2.34, 2.03, 1.32, 2.65)/100
  ...
  d.sets.prov$NatvLng_KhmerPerc =                        # NIS CIPS, Report 7, 2014
  ...
  d.sets.prov$PopAnulGrowRate =                      # NIS CIPS, Report 10, 2014
    c(1.47, 1.79, -2.51, 4.39, 3.99, 0.58, 3.61)/100
  ...
  d.sets.prov$FHeadHHPerc =                          # NIS CIPS, Report 10, 2014
    c(20.6, 24.6, 25.8, 23.8, 33.6, 24.9, 27.6)/100
  d.sets.prov$NuclrFamPerc =                         # NIS CIPS, Report 10, 2014
    c(65.9, 66.5, 66.3, 74.0, 61.1, 64.5, 68.4)/100
  
  d.sets.prov$IDPoorHHPerc =                        # IDPoor reports, 2015
    c(17.5, 22.5, 17.7, 17.1, 23.6, 17.7, 17.3)/100
  
  d.sets.prov$IDPoorPopPerc =                        # IDPoor reports, 2015
    c(17.3, 20.3, 16.0, 16.7, 20.7, 16.2, 14.9)/100
...
# missmap(d, main = "Missing Values in Variables", legend = F)
```
```{r analyze_prov_intentions, include = FALSE}
# Frequency Analysis of Intentions by Province
# d.backup = d
# d.sets.prov.backup = d.sets.prov
# d = d.backup
# d.sets.prov = d.sets.prov.backup
d = subset(d, !is.na(IntndPitFull) & !is.na(Prov))
# print(sapply(d, function(x) sum(is.na(x))))
# Check for colinear (correlated) variables
# varTable(d)
length(d.sets.prov[1,])
x = 68
corrplot(cor(d.sets.prov[,(2 + x):(12 + x)]))
# summary(d.sets.prov$IDPoorPopPerc, maxsum = 500)
names(d.sets.prov)
d.sets.prov = subset(d.sets.prov, 
                     select = c(Prov, Pop13FPerc, PopChng08to13Perc,
                                PopDens13, PopDensChng08to13,
                                MigrntNet, GndrRatio1564,
                                MedAge13, Pop1549Perc,
                                MaridNevrMPerc, MaridNevr2024DiffMFPerc,
                                MaridFPerc,
                                DvrcdSepMPerc, DvrcdSepFPerc,
                                MeanAgeMaridF, MeanAgeMaridDiffMF,
                                DisabPerc, DisabMedAge,
                                DisabEconAct1564Perc,
                                NatvLng_KhmerPerc, GenLitRat13,
                                GenLitRatChng08to13,
                                GenLitRatDiffChng08to13MF,
                                EducPrimIncomp, EducPrimComp,
                                EducLowSecndComp, EducSecndCompNAbov,
                                SchlAttnd13, SchlAttndChng08to13,
                                SchlAttndDiffChng08to13MF,
                                SchlAttndPerc5dwn, SchlAttndPerc614,
                                SchlAttndPerc2024, SchlAttndPerc25up,
                                FertRat13, 
                                EconAct15up13, EconAct15upChng08to13,
                                JobEmplyr13, JobEmplye13, JobSlfEmplyd13,
                                JobSectrGov13, JobSectrStateEntrprs13,
                                JobSectrCambPrivEntrprs13,
                                JobSectrNonProfOthr13,
                                JobManufctr13,
                                JobWhlslRetlTradOthr13, JobManagr, 
                                JobProfsnl, JobServcSals, JobCraft,
                                JobElementry, JobSecndJobPerc,
                                JobChld514Perc, JobUnemply1524Perc,
                                BldngsPermRoofwallFlorPerc, 
                                HshldsAvgNumPpl, 
                                HshldsLightElecPerc, HshldsLightKeroPerc,
                                HshldsCookFuelWoodPerc,
                                HshldsCookFuelLPGPerc,
                                HshldsDrnkWtrPipedPerc,
                                HshldsDrnkWtrTubPipWelPerc,
                                HshldsDrnkWtrProtDugWelPerc,
                                HshldsDrnkWtrRainPerc, 
                                HshldsDrnkWtrSprngRivrPerc,
                                HshldsDrnkWtrPurchsdPerc,
                                HshldsDrnkWtrOnSitePerc,
                                HshldsDrnkWtrNearPerc,
                                HshldsToi13Perc,
                                HshldsToiChng08to13Perc,
                                HshldsToiSewer13Perc, HshldsToiSeptc13Perc, 
                                HshldsToiLatrn13Perc, HshldsImprvdWtr,
                                HshldsImprvdToi, HshldsImprvdWtrToiElec,
                                FHeadHHPerc, NuclrFamPerc,
                                IDPoorPopPerc, LatCovPerc
                                ))
summary(d.sets.prov)
print(sapply(d.sets.prov, function(x) sum(is.na(x))))

# Correlation of IntndPitFull(Des) with census and other provincial-level data


# d.sets.prov = subset(d.sets.prov, !is.na(IDPoorPopPerc))
d.sets.prov = droplevels(d.sets.prov)
# Analyze frequencies
freqs.2way.IntndPitFull.Prov = freqs.2way(d, "IntndPitFull", "Prov", 1)
...
rownames(prop.col) = c("IntndPay", "IntndPit", "IntndSlfEmp", "IntndDK",
                       "IntndStop", "IntndOthr")
order2 = c("Oddar Meanchey", "Banteay Meanchey", "Siem Reap", "Kampong Thom", 
           "Kandal", "Prey Veng", "Svay Rieng")
prop.col = prop.col[,match(order2, colnames(prop.col)),drop = FALSE]
prop.col = t(prop.col)
# head(d.sets.prov[1:10], n = 10)
d.sets.prov = d.sets.prov[match(order2, d.sets.prov$Prov),]
for (i in 2:length(d.sets.prov)) {
  prop.col = cbind(prop.col, as.table(d.sets.prov[,i]))
  colnames(prop.col)[length(prop.col[1,])] = colnames(d.sets.prov)[i]
}
print(prop.col)
df.wide = data.frame(temp = prop.col)
names(df.wide) = colnames(prop.col)
freqs.2way.IntndPitFullDes.Prov = freqs.2way(d, "IntndPitFullDes", "Prov", 1)
crosstable.IntndPitFullDes.Prov =
  CrossTable(freqs.2way.IntndPitFullDes.Prov[[2]])
# print(crosstable.IntndPitFullDes.Prov)
IntndPitFullDes.prop.col = crosstable.IntndPitFullDes.Prov$prop.col
# typeof(prop.col)
order2 = c("Oddar Meanchey", "Banteay Meanchey", "Siem Reap", "Kampong Thom", 
           "Kandal", "Prey Veng", "Svay Rieng")
IntndPitFullDes.prop.col = 
  IntndPitFullDes.prop.col[,match(order2, colnames(IntndPitFullDes.prop.col)),
                           drop = FALSE]
IntndPitFullDes.prop.col = t(IntndPitFullDes.prop.col)
df.wide$IntndPitFullDes = IntndPitFullDes.prop.col[,2]
df.wide$MultiPovIndex = c(0.233, 0.189, 0.240, 0.271, 0.170, 0.223, 0.229)
df.long = data.frame(temp = as.table(prop.col))
names(df.long) = c("Prov", "Variable", "Value")
# Model intentions in each province using logistic regression
# Model 0: cbind(IntndPitFullDes.desirable, IntndPitFullDes.undesirable)
IntndPitFullDes.freqs = t(freqs.2way.IntndPitFullDes.Prov[[2]])
IntndPitFullDes.freqs = 
  IntndPitFullDes.freqs[match(order2,
                                   rownames(IntndPitFullDes.freqs)), ,
                            drop = FALSE]
df.wide$IntndPitFullDes.desirable = IntndPitFullDes.freqs[,2]
df.wide$IntndPitFullDes.undesirable = IntndPitFullDes.freqs[,1]
names(df.wide)
dep_var = "cbind(IntndPitFullDes.desirable, IntndPitFullDes.undesirable)"
indep_vars = subset(data.frame(vars = names(df.wide)),
                    vars != "IntndPay" & vars != "IntndPit" & 
                      vars != "IntndSlfEmp" & vars != "IntndDK" & 
                      vars != "IntndStop" & vars != "IntndOthr" &
                      vars != "IntndPitFullDes" &
                      vars != "IntndPitFullDes.desirable" &
                      vars != "IntndPitFullDes.undesirable")
formula = paste(dep_var, " ~ ", paste(indep_vars$vars, collapse = " + "), sep = "")
lrfit = glm(formula = as.formula(formula), data = df.wide, family = binomial)
1-pchisq(0,0)
summary(lrfit)
...
# Model 1: IntndPitFullDes
names(df.wide)
dep_var = "IntndPitFullDes"
indep_vars = subset(data.frame(vars = names(df.wide)),
                    vars != "IntndPay" & vars != "IntndPit" & 
                      vars != "IntndSlfEmp" & vars != "IntndDK" & 
                      vars != "IntndStop" & vars != "IntndOthr" &
                      vars != "IntndPitFullDes")
formula = paste(dep_var, " ~ ", paste(indep_vars$vars, collapse = " + "), sep = "")
results = genlinmod(formula = as.formula(formula), data = df.wide, 
                    iter = 1, perc_train = 1, return = 1)
# Vars with low p:
# Vars with low reduction in residual deviance:
print(results)
...
# ggplot(df, aes(x = Prov, y = Value, fill = IntndPitFull)) +
#   geom_col() + 
#   coord_flip()
# # Pyramid plot (used in FSM intentions article)
...
```
```{r analyze_surveys, include = FALSE}
names(d)
boxplot(IDPoorHHpercDist ~ IntndPitFull, data = d, 
        ylab = "IDPoorHHpercDist vs. IntndPitFull")
d$IDPoorHHpercDist = d$IDPoorHHpercDist/100
summary(d$SatisSup)

# DISCRIMINANT ANALYSIS
# formulae:
# IntndPitFull ~ Prov + Satis + Mnth + RecSup + Yr + SatisSup + RDefBefor_BshFld + ChlngsFlood + IDPoor
# IntndPitFull ~ Prov
# test = paste(names(d), collapse = " + ")
# d.backup = d
# d = d.backup
options(max.print = 5.5E5)
d = subset(d, !is.na(IntndPitFull) & 
             !is.na(Prov) & 
             !is.na(Satis) & 
             !is.na(Mnth) & 
             !is.na(RecSup) & 
             !is.na(Yr) & 
             !is.na(SatisSup) & 
             !is.na(RDefBefor_BshFld) & 
             !is.na(ChlngsFlood) & 
             !is.na(IDPoor) )
d = subset(d, select = -c(Date, LBO, Dist, Comm, Vill, IDPoorTyp,
                          M01, M1824, M217, M2559, M60, 
                          F01, F1824, F217, F2559, F60,  
                          DateSlabPur, LatInst, BelowGrndInst,
                          DateBelowGrndInst, ShltrInst,
                          DateInstComp, RDefBefor, RDefBeforOthr,
                          FreqNeiToi,  
                          KnwSubsdy, BorwLat, 
                          CanBuyLat, UseFincOthr, SlabTil, 
                          Npits, PitConfig, NringsDir, 
                          NringsOff, NringsOthr, WallMatOthr,
                          RoofMatOthr,
                          MatsPurTgthr, Cost,
                          CostInclInst, CostPitSlab, 
                          CostPitSlabKnwn, CostShltrMats,
                          CostShltrMatsKnwn, 
                          LabPitShltrPurTgthr, CostLabLat,
                          CostLabPitSlab, CostLabPitSlabKnwn,
                          CostLabShltr, CostLabShltrKnwn,
                          LatTypOwndBefor, IntndChngDich,
                          IntndChng,
                          IntndChngOthr, AdltUseLat,
                          ChldUseLat, InfLatDump, 
                          IntndPitFullOthrAns,
                          Chlngs, Satis, SatisSup,
                          DateSurvCreated, YrMnth,
                          RDefBefor_RivPnd, RDefBefor_NeiToi,
                          RDefBefor_Othr, RDefBefor_NAAlwysToi,
                          IntndChng_Shltr, IntndChng_Shwr,
                          IntndChng_Sink, IntndChng_WtrRes,
                          IntndChng_Pit, IntndChng_Othr, 
                          IntndChng_NAAlwysToi, IntndPitFullDes,
                          IntndPitFullPit, IntndPitFullEmpSlf,
                          IntndPitFullDK, IntndPitFullOthr,
                          IntndPitFullPay, IntndPitFullStop,
                          SatisColapsMore, SatisSupColapsMore,
                          Pop13, Pop13M, Pop13F, PopChng08to13,
                          PopChng08to13M, PopChng08to13F,
                          MigrntIn, MigrntOut, MigrntNet,
                          AreaKm2))
# additional options to remove: Prov
d = subset(d, !is.na(RoofMat) &
             !is.na(Rec) &
             Yr != 2014 &
             !is.na(IDPoor1HHpercDist) &
             !is.na(IDPoor1HHpercComm) &
             !is.na(IDPoor1HHpercVill) &
             !is.na(IDPoor2HHpercVill) &
             !is.na(IDPoorPopPerc))
# & IntndPitFull != "Othr"
d = subset(d, select = -c(IDPoorHHpercDist, IDPoorHHpercComm,
                          IDPoor1HHpercDist, IDPoor2HHpercDist, 
                          IDPoor1HHpercComm, IDPoor2HHpercComm, 
                          IDPoor1HHpercVill, IDPoor2HHpercVill))
print(sapply(d, function(x) sum(is.na(x))))
# Check for colinear (correlated) variables
varTable(d)
d = subset(d, select = -c(Pop13MPerc, 
                          PopChng08to13MPerc,
                          PopChng08to13FPerc,
                          PopGrow08to13Perc,
                          MedAge13M, MedAge13F,
                          AgedChildRatio, AgeDepRatio,
                          MaridNevrM, MaridNevr2024M,
                          MaridNevrF, MaridNevr2024F,
                          MaridNevr4549F,
                          MaridM,
                          WidwdM, Widwd60upM,
                          Widwd60upF,
                          MeanAgeMaridM,
                          DisabFPerc,
                          GenLitRat13M, GenLitRat13F,
                          GenLitRatChng08to13M,
                          EducLowSecndComp,
                          EducSecndCompNAbov,
                          SchlAttnd13,
                          SchlAttndChng08to13M,
                          SchlAttndChng08to13F,
                          FertRatChng08to13,
                          JobIndstryTer13,
                          JobAgForFshM13, JobAgForFshF13,
                          JobManufctrM13, JobManufctrF13,
                          JobWhlslRetlTradOthrM13,
                          JobWhlslRetlTradOthrF13,
                          BldngsPermWallPerc,
                          BldngsPermFlorPerc,
                          BldngsPermRoofWallPerc
                          ))
x = 145 - 34
length(d[1,])
corrplot(cor(d[,(24 + x):(34 + x)]))
d = droplevels(d)
summary(d)
# Create formula for discriminant analysis
indep_vars = subset(data.frame(vars = names(d)),
                    vars != "IntndPitFull")
dep_var = "IntndPitFull"
formula = paste(dep_var, " ~ ", paste(indep_vars$vars, collapse = " + "), sep = "")
# Create training and testing data sets
set.seed(123)
training.samples = d$IntndPitFull %>% createDataPartition(p = 0.80, list = FALSE)
train.data = d[training.samples, ]
test.data <- d[-training.samples, ]
# Normalize data (categorical vars automatically ignored)
preproc.param = train.data %>%    # Estimate preprocessing parameters
  preProcess(method = c("center", "scale"))
train.transformed = preproc.param %>% predict(train.data)  # Transform data
test.transformed = preproc.param %>% predict(test.data)    # using the estimated parameters
# Linear, Quadratic, Mixture, and Flexible models
lda_model = lda(as.formula(formula), data = train.transformed)  # Proportion of trace = Percent between-group variance explained by each linear discriminant
qda_model = qda(as.formula(formula), data = train.transformed)
mda_model = mda(as.formula(formula), data = train.transformed)
fda_model = fda(as.formula(formula), data = train.transformed)
rda_model = rda(as.formula(formula), data = train.transformed)
lda_model
qda_model
mda_model
fda_model
rda_model
plot(lda_model)  # TAKES FOREVER TO RENDER
plot(qda_model)  # NOT WORKING
plot(mda_model)  # NOT WORKING
plot(fda_model)  # NOT WORKING
plot(rda_model)  # NOT WORKING
str(lda_model)
str(qda_model)
str(mda_model)
str(fda_model)
...
print(sapply(test.transformed, function(x) sum(is.na(x))))
varTable(test.transformed)
lda_prediction = predict(lda_model, test.transformed)
qda_prediction = predict(qda_model, test.transformed)
mda_prediction = predict(mda_model, test.transformed)
fda_prediction = predict(fda_model, test.transformed)
rda_prediction = predict(rda_model, test.transformed)
mean(lda_prediction$class == test.transformed$IntndPitFull)
mean(qda_prediction$class == test.transformed$IntndPitFull)
mean(mda_prediction == test.transformed$IntndPitFull)
mean(fda_prediction == test.transformed$IntndPitFull)
mean(rda_prediction$class == test.transformed$IntndPitFull)
str(lda_prediction)
str(qda_prediction)
str(mda_prediction)
str(fda_prediction)
...
# Plotting discriminant analyses
par(mar = c(1,1,1,1))
ldahist(data = lda_prediction$x[,1], g = test.transformed$IntndPitFull)
lda_dataset = data.frame(intent = test.transformed[,"IntndPitFull"],
                         lda = lda_prediction$x)
prop.lda = lda_model$svd^2/sum(lda_model$svd^2)
plot1 = ggplot(lda_dataset) + 
  geom_point(aes(lda.LD1, lda.LD2, colour = intent, shape = intent), size = 2.5) + 
  labs(x = paste("LD1 (", percent(prop.lda[1]), ")", sep = ""),
       y = paste("LD2 (", percent(prop.lda[2]), ")", sep = ""))
plot2 = ggplot(lda_dataset) + 
  geom_point(aes(lda.LD2, lda.LD3, colour = intent, shape = intent), size = 2.5) + 
  labs(x = paste("LD2 (", percent(prop.lda[2]), ")", sep = ""),
       y = paste("LD3 (", percent(prop.lda[3]), ")", sep = ""))
plot3 = ggplot(lda_dataset) + 
  geom_point(aes(lda.LD3, lda.LD4, colour = intent, shape = intent), size = 2.5) + 
  labs(x = paste("LD3 (", percent(prop.lda[3]), ")", sep = ""),
       y = paste("LD4 (", percent(prop.lda[4]), ")", sep = ""))
grid.arrange(plot1, plot2, plot3)


# Other functions
names(predictions)
head(predictions$class, 6)   # Predicted classes
head(predictions$posterior, 6)    # Predicted probabilities of class memebership
head(predictions$x, 3)    # Linear discriminants
lda.data <- cbind(train.transformed, predict(model)$x)
ggplot(lda.data, aes(LD1, LD2)) + geom_point(aes(color = Species))
mean(predictions$class[!is.na(predictions$class)] == 
       test.transformed$IntndPitFull[!is.na(predictions$class)])
mean(predicted.classes == test.transformed$IntndPitFull)


# Example from https://www.r-bloggers.com/a-brief-look-at-mixture-discriminant-analysis/
set.seed(42)
n <- 500
...
# Example from https://gist.github.com/thigm85/8424654
require(MASS)
require(ggplot2)
require(scales)
require(gridExtra)
...
# KMEANS CLUSTERING
set.seed(20)
cluster <- kmeans(data.frame(d$Prov, d$IDPoor), 5, nstart = 20)
irisCluster
table(irisCluster$cluster, iris$Species)
irisCluster$cluster <- as.factor(irisCluster$cluster)
ggplot(iris, aes(Petal.Length, Petal.Width, color = iris$cluster)) + geom_point()

# Example from https://www.r-bloggers.com/k-means-clustering-in-r/
set.seed(20)
...
set.seed(123)
training.samples = d$IntndPitFull %>% createDataPartition(p = 0.8, list = FALSE)
train.data  = d[training.samples, ]
test.data = d[-training.samples, ]
# formulae: IntndPitFull ~ IDPoorHHpercDist
model = nnet::multinom(IntndPitFull ~ Prov + Satis + Mnth + RecSup + Yr + 
                         SatisSup + RDefBefor_BshFld + ChlngsFlood + IDPoor, 
                       data = train.data, maxit = 300)
summary(model)
predicted.classes = model %>% predict(test.data)
head(predicted.classes)
mean(na.omit(predicted.classes == test.data$IntndPitFull))

# ml$prog2 <- relevel(ml$prog, ref = "academic")   # Set baseline factor if needed
# summary(d$IntndPitFull)
results = multinom(formula = IntndPitFull ~ Prov + Satis + Mnth + RecSup + Yr + SatisSup + RDefBefor_BshFld + ChlngsFlood + IDPoor, data = d, maxit = 300)
summary(results)
z = summary(results)$coefficients/summary(results)$standard.errors; print(z)
(1 - pnorm(abs(z), 0, 1)) * 2                                    # 2-tailed z test
exp(coef(results))
head(pp <- fitted(results))


# LOGISTIC REGRESSION (requires binary dep var: Desirability of FSM Intentions)
# d.backup = d
# d = d.backup
summary(d)
d = subset(d, select = c(IntndPitFullDes, Prov, Satis, Mnth, RecSup, Yr,
                         SatisSup, RDefBefor_BshFld, ChlngsFlood, IDPoor,
                         IDPoorHHpercDist))
d = subset(d, !is.na(IntndPitFullDes) & !is.na(Prov) & !is.na(Satis) & 
             !is.na(Mnth) & !is.na(RecSup) & !is.na(Yr) & !is.na(SatisSup) & 
             !is.na(RDefBefor_BshFld) & !is.na(ChlngsFlood) & 
             !is.na(IDPoor) & !is.na(IDPoorHHpercDist))
print(sapply(d, function(x) sum(is.na(x))))
d = droplevels(d)
summary(d)
varTable(d)
...
dep_var = "IntndPitFullDes"
indep_vars = subset(data.frame(vars = names(d)), vars != dep_var)
formula = paste(dep_var, " ~ ", paste(indep_vars$vars, collapse = " + "), sep = "")
# Model 1
# IntndPitFullDes ~ Prov + Satis + Mnth + RecSup + Yr + SatisSup + RDefBefor_BshFld + ChlngsFlood + IDPoor + IDPoor1HHpercDist + IDPoor2HHpercDist
results = genlinmod(formula = as.formula(formula), data = d, 
                    iter = 1, perc_train = 1, return = 1)
results = genlinmod(formula = as.formula(formula), data = d, 
                    iter = 100, perc_train = 0.80, return = 1)
print(results)
print(summary(results[[2]]))
print(anova(results[[2]], test = "Chisq"))
# Test model
...
formula = paste(dep_var, " ~ ", 
                paste(indep_vars$vars[27:37], collapse = " + "), sep = "")
results = genlinmod(formula = "IntndPitFullDes ~ Prov + Yr + Mnth + IDPoor + RDefBefor_BshFld + ChlngsFlood + Satis + SatisSup + RecSup + Pop13FPerc + PopChng08to13Perc + PopDens13 + PopDensChng08to13 + MigrntNetPercPop + GndrRatio014 + GndrRatio1564 + GndrRatio65up + MedAge13 + Pop014Perc + Pop1549Perc",
                    data = d, iter = 1, perc_train = 1, return = 1)
x = 145 - 34
length(d[1,])
corrplot(cor(d[,28:38]))
...
print(results)
# results = genlinmod(data = d, 
#                     formula = paste("IDPoorHHpercDist ~ IntndPitFull"),
#                     iter = 1, perc_train = 0.70, return = 1)
# print(results[[2]])
# summary(results[[2]])
# print(anova(results[[2]], test = "Chisq"))
# pR2(results[[2]])
# PseudoR2(results[[2]], which = "all")
# print(confint(results[[2]]))

# POINT-BISERIAL CORRELATION (function requires continuous dep var and binary indep var)
# biserial.cor(x = d$IDPoorHHpercDist, y = d$IntndPitFull, use = "complete.obs")

# FREQUENCY ANALYSIS (only for categorical vars)
# freqs.2way(data = d, metric1 = "IntndPitFull", metric2 = "IDPoorHHpercDist")
