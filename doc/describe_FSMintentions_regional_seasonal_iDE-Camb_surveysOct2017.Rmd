...
if (clean.raw.data != 1) {
  ...
  d.set.prov$DisabPerc =                             # NIS CIPS, Report 5, 2013
    c(1.90, 3.36, 1.60, 3.54, 2.19, 2.43, 1.88)
  d.set.prov$DisabMPerc =                            # NIS CIPS, Report 5, 2013
    c(1.98, 3.56, 1.54, 4.43, 2.03, 2.86, 2.45)
  d.set.prov$DisabFPerc =                            # NIS CIPS, Report 5, 2013
    c(1.83, 3.17, 1.65, 2.34, 2.03, 1.32, 2.65)
  d.set.prov$DisabMedAge =                           # NIS CIPS, Report 5, 2013
    c(43.91, 48.52, 45.77, 47.65, 46.00, 37.93, 46.40)
  d.set.prov$DisabMedAgeM =                          # NIS CIPS, Report 5, 2013
    c(47.84, 39.58, 35.99, 47.92, 40.40, 39.69, 45.02)
  d.set.prov$DisabMedAgeF =                          # NIS CIPS, Report 5, 2013
    c(39.56, 53.06, 47.90, 46.36, 51.64, 32.77, 48.97)
  d.set.prov$DisabEconAct1564Perc =                  # NIS CIPS, Report 5, 2013
